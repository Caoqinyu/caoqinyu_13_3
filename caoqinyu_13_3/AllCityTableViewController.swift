...
class AllCityTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        cityURL = ["http://t.weather.sojson.com/api/weather/city/101010100","http://t.weather.sojson.com/api/weather/city/101270101","http://t.weather.sojson.com/api/weather/city/101030100"]
        allCity = ["北京","成都","天津"]
